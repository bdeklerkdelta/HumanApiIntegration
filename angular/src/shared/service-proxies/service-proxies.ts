...
@Injectable()
export class HumanApiDataServiceProxy {
    private http: HttpClient;
    private baseUrl: string;
    protected jsonParseReviver: ((key: string, value: any) => any) | undefined = undefined;
     ...
     * @return Success
     */
    syncData(body: undefined): Observable<void> {
        let url_ = this.baseUrl + "/api/services/app/HealthInfo/InsertHumanApiData";
        url_ = url_.replace(/[?&]$/, "");
    ...
    protected processSyncData(response: HttpResponseBase): Observable<void> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
     ...
     * @return Success
     */
     getAllHumanApiData(): Observable<HumanApiDataDto[]> {
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processGetAllHumanApiData(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processGetAllHumanApiData(<any>response_);
                } catch (e) {
                    return <Observable<HumanApiDataDto[]>><any>_observableThrow(e);
                }
            } else
                return <Observable<HumanApiDataDto[]>><any>_observableThrow(response_);
        }));
    }

    protected processGetAllHumanApiData(response: HttpResponseBase): Observable<HumanApiDataDto[]> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = HumanApiDataDtoListResultDto.fromJS(resultData200);
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
        ...
        return _observableOf<HumanApiDataDto[]>(<any>null);
    }
}
...
export class TokenAuthServiceProxy {
     ...
     * @return Success
     */
     getHumanApiSessionToken(): Observable<HumanApiSessionResultModel> {
        let url_ = this.baseUrl + "/api/services/app/HealthInfo/GetHumanApiSession";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processGetHumanApiSessionToken(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processGetHumanApiSessionToken(<any>response_);
                } catch (e) {
                    return <Observable<HumanApiSessionResultModel>><any>_observableThrow(e);
                }
            } else
                return <Observable<HumanApiSessionResultModel>><any>_observableThrow(response_);
        }));
    }

    protected processGetHumanApiSessionToken(response: HttpResponseBase): Observable<HumanApiSessionResultModel> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = HumanApiSessionResultModel.fromJS(resultData200);
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
        ...
        return _observableOf<HumanApiSessionResultModel>(<any>null);
    }
...
export class HumanApiSessionResultModel implements IHumanApiSessionResultModel {
    sessionToken: string | undefined;
    expireInSeconds: number;

    constructor(data?: IHumanApiSessionResultModel) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): HumanApiSessionResultModel {
        data = typeof data === 'object' ? data : {};
        let result = new HumanApiSessionResultModel();
        result.init(data);
        return result;
    }
    ...
    clone(): HumanApiSessionResultModel {
        const json = this.toJSON();
        let result = new HumanApiSessionResultModel();
        result.init(json);
        return result;
...
export interface IHumanApiSessionResultModel {
    sessionToken: string | undefined;
    expireInSeconds: number;
}

export class HumanApiDataDto implements IHumanApiDataDto {
    id: string;

    constructor(data?: HumanApiDataDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): HumanApiDataDto {
        data = typeof data === 'object' ? data : {};
        let result = new HumanApiDataDto();
        result.init(data);
        return result;
    }
...
export interface IHumanApiDataDto {
    id: string;
}

export class HumanApiDataDtoListResultDto implements IHumanApiDataDtoListResultDto {
    items: HumanApiDataDto[] | undefined;

    constructor(data?: IHumanApiDataDtoListResultDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    init(data?: any) {
        if (data) {
            if (Array.isArray(data["items"])) {
                this.items = [] as any;
                for (let item of data["items"])
                    this.items.push(HumanApiDataDto.fromJS(item));
            }
        }
    }

    static fromJS(data: any): HumanApiDataDtoListResultDto {
        data = typeof data === 'object' ? data : {};
        let result = new HumanApiDataDtoListResultDto();
        result.init(data);
        return result;
    }
    ...
    clone(): HumanApiDataDtoListResultDto {
        const json = this.toJSON();
        let result = new HumanApiDataDtoListResultDto();
        result.init(json);
        return result;
...
export interface IHumanApiDataDtoListResultDto {
    items: HumanApiDataDto[] | undefined;
}
