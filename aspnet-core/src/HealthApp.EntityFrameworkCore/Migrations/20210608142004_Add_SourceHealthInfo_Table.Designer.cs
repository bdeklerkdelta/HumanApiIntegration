...
namespace HealthApp.Migrations
{
    ...
    [Migration("20210608142004_Add_SourceHealthInfo_Table")]
    partial class Add_SourceHealthInfo_Table
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HealthApp.HealthInfo.HealthInfo", b =>
                {
                    ...
                    b.Property<double>("TrackerCalories")
                        .HasColumnType("float");

                    b.Property<double>("TrackerDistance")
                        .HasColumnType("float");

                    b.Property<double>("TrackerElevation")
                        .HasColumnType("float");

                    b.Property<double>("TrackerFloors")
                        .HasColumnType("float");

                    b.Property<int>("TrackerSteps")
                        .HasColumnType("int");

                    b.Property<int>("UserId")
                        .HasColumnType("int");

                    b.Property<double>("Vigorous")
                        .HasColumnType("float");
            ...
            modelBuilder.Entity("Abp.Authorization.Roles.RoleClaim", b =>
                {
                    b.HasOne("HealthApp.Authorization.Roles.Role", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Abp.Authorization.Users.UserClaim", b =>
                {
                    b.HasOne("HealthApp.Authorization.Users.User", null)
                        .WithMany("Claims")
